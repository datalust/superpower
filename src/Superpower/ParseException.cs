...
public class ParseException(string message, Position errorPosition, Exception? innerException) : Exception(message, innerException)
{
	/// <summary>
	...
	/// </summary>
	public Position ErrorPosition { get; } = errorPosition;
}
