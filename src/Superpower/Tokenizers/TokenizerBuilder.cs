...
{
	readonly struct Recognizer(TextParser<Unit> parser, bool isIgnored, TKind kind, bool isDelimiter)
	{
		public TextParser<Unit> Parser { get; } = parser;
		public bool IsIgnored { get; } = isIgnored;
		public TKind Kind { get; } = kind;
		public bool IsDelimiter { get; } = isDelimiter;
	}

	readonly List<Recognizer> _recognizers = [];
